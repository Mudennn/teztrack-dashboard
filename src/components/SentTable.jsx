    ...
    useEffect(() => {
      if (wallet) {
        const fetchBalance = async () => {
          ...
          const fetchURL = `${baseURL}v1/operations/transactions?sender=${wallet}&limit=10000&sort.desc=id`;
          ...
          <div className="flex flex-col justify-center h-full mt-4">
            <div className="w-full max-w-4xl mx-auto bg-white shadow-lg rounded-sm border border-gray-200">
              <header className="px-5 py-4 border-b border-gray-100">
                <h2 className="font-semibold text-gray-800">Send History</h2>
              </header>
              <div className="p-3">
