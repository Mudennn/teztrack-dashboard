...
declare const name = "UpdateStreamStatus";
...
declare type ApiParams = PathParams & BodyParams;
export declare type UpdateStreamEvmStatusParams = ApiParams;
export declare const updateStreamEvmStatus: import("@moralisweb3/api-utils").EndpointFactory<ApiParams, ApiParams, {
    webhookUrl: string;
    description: string;
    tag: string;
...
export {};
//# sourceMappingURL=updateStreamEvmStatus.d.ts.map