...
declare const name = "UpdateStream";
...
declare type ApiParams = BodyParams & PathParams;
export interface UpdateStreamEvmParams extends Camelize<Omit<ApiParams, 'chainIds'>> {
    chains: EvmChainish[];
}
export declare const updateStreamEvm: import("@moralisweb3/api-utils").EndpointFactory<ApiParams, UpdateStreamEvmParams, {
    webhookUrl: string;
    description: string;
    tag: string;
    ...
    chainIds: string[];
    id: string;
    status: Camelize<"active" | "paused" | "error">;
    statusMessage: string;
}, {
...
export {};
//# sourceMappingURL=updateStreamEvm.d.ts.map