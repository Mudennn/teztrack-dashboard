...
exports.MoralisStreams = exports.BASE_URL = void 0;
...
var getHistory_1 = require("./resolvers/history/getHistory");
var replayHistory_1 = require("./resolvers/history/replayHistory");
...
exports.BASE_URL = 'https://api.moralis-streams.com';
var MoralisStreams = /** @class */ (function (_super) {
    __extends(MoralisStreams, _super);
    function MoralisStreams(core) {
        var _this = _super.call(this, MoralisStreams.moduleName, core, exports.BASE_URL) || this;
        ...
        _this.getHistory = _this.endpoints.createFetcher(getHistory_1.getHistory);
        ...
        _this.parsedLogs = function (options) { return (0, logParser_1.parseLog)(options); };
        return _this;
    }
