...
export declare class MoralisCore {
     ...
     */
    start: (providedConfig?: Partial<MoralisConfigValues>) => Promise<void>;
}
//# sourceMappingURL=MoralisCore.d.ts.map