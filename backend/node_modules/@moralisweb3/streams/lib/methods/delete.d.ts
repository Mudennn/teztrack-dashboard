...
import { DeleteStreamEvmParams } from '../resolvers';
export interface DeleteStreamEvmOptions extends DeleteStreamEvmParams {
    networkType?: 'evm';
}
export declare type DeleteStreamOptions = DeleteStreamEvmOptions;
export declare const makeDeleteStream: (endpoints: Endpoints) => ({ networkType, ...options }: DeleteStreamOptions) => Promise<import("@moralisweb3/api-utils").ApiResultAdapter<{
    webhookUrl: string;
    description: string;
    tag: string;
