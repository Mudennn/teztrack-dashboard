...
const FetchDefiToken = ({ wallet, defiBalance, setDefiBalance}) => {
                            ...
                            <tr key={defi.id}>
                                <td className="p-2 whitespace-nowrap">
                                    <div className="flex items-center">
                                        ...
                                        <div className="font-medium text-gray-800 ml-2 ">
                                            <p className='font-bold'>{defi.token.metadata.symbol}</p>
                                            <p className='text-xs text-gray-500'>{defi.token.metadata.name}</p>
                                        </div>
                                    </div>
                                </td>
                                ...
                                <td className="p-2 whitespace-nowrap">
                                    <div className="text-right font-medium text-gray-900">
                                        ...
                                        <p className='text-xs text-gray-500'>{defiFormat(defi.balance)}</p>
                                    </div>
                                </td>
                              </tr>
                        ))}
