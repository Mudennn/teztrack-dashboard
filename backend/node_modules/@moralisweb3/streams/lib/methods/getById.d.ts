...
export declare type GetStreamOptions = GetStreamEvmOptions;
export declare const makeGetStreamById: (endpoints: Endpoints) => ({ network, ...options }: GetStreamOptions) => Promise<import("@moralisweb3/api-utils").ApiResultAdapter<{
    webhookUrl: string;
    description: string;
    tag: string;
