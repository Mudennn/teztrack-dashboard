...
declare const name = "GetStreams";
declare type Name = typeof name;
declare type QueryParams = operations[Name]['parameters']['query'];
declare type ApiParams = QueryParams;
export declare type GetStreamsEvmParams = ApiParams;
export declare const getStreamsEvm: import("@moralisweb3/api-utils").PaginatedEndpointFactory<{
    limit: number;
...
export {};
//# sourceMappingURL=getStreamsEvm.d.ts.map