...
declare const name = "DeleteStream";
declare type Name = typeof name;
declare type PathParams = operations[Name]['parameters']['path'];
declare type ApiParams = PathParams;
export declare type DeleteStreamEvmParams = ApiParams;
export declare const deleteStreamEvm: import("@moralisweb3/api-utils").EndpointFactory<{
    id: string;
}, {
    id: string;
}, {
...
export {};
//# sourceMappingURL=deleteStreamEvm.d.ts.map